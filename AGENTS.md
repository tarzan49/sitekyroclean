...
Correção explícita do responsável (13/09/2026): a mudança para verde nos destaques não foi autorizada. Overlines, palavras em destaque dos títulos, categorias de artigos e destaques dos guias mantêm sempre o dourado canónico #D4AF37, incluindo sobre fundos claros. Preservar esta identidade cromática ao alterar tipografia. Descrições secundárias mantêm #505650. Não extrapolar a aprovação para mudanças de preços, promessas ou fluxos comerciais.
