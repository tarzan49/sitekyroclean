...
export function buildSocialProofMessages(location: string): SocialProofMessage[] {
  ...
  return [
    ...
    { category: 'trust', text: `Mais de 1100 clientes satisfeitos · Avaliação ${REVIEW_RATING} no Google` },
    { category: 'trust', text: `Mais de ${REVIEW_COUNT} avaliações reais no Google, ${REVIEW_RATING} estrelas` },
