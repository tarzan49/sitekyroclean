                        ...
                        return (
                          ...
                          >
                            {showStepper && (
                              ...
                              >
                                <button type="button" onClick={() => adjustRowQty(i, quizConfig, -1)} className="w-9 h-9 flex items-center justify-center rounded-full text-[#111111]/40 hover:bg-[rgba(7,26,18,0.08)] transition-colors" aria-label="Diminuir quantidade">
                                  <Minus className="w-4 h-4" />
                                </button>
                                <span className="w-7 text-center font-playfair text-lg font-bold tabular-nums text-[#111111]">{qty}</span>
                                <button type="button" onClick={() => adjustRowQty(i, quizConfig, 1)} className="w-9 h-9 flex items-center justify-center rounded-full text-[#111111]/40 hover:bg-[rgba(7,26,18,0.08)] transition-colors" aria-label="Aumentar quantidade">
