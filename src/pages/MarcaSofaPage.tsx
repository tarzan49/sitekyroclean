  ...
  return (
    ...
    <>
      ...
      <main>
        ...
        <CommercialHero title={`Limpeza de Sofá ${marca.name} ${prep} ${city.name}`} serviceSlug="limpeza-sofas" city={city.name} price={`${marca.minPrice}€`} image={heroImg} whatsappHref={`${WHATSAPP_BASE}?text=${encodeURIComponent(`Olá! Gostaria de pedir um orçamento para limpeza de sofá ${marca.name} ${prep} ${city.name}.`)}`} source={`marca_hero_${marca.slug}`} />
