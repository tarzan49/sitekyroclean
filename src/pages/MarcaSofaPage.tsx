...
import { XCircle, CheckCircle2, ArrowRight, Search, ShieldCheck, Droplets, Wind, Star, Euro, Clock, Timer } from "lucide-react";
                ...
                <div className="mt-8 lg:mt-0">
                  <div className="relative">
                    ...
                    <div className="relative shadow-2xl" style={{ borderTop: "2px solid #D4AF37" }}>
                      <HeroBeforeAfterPool category="sofa" className="w-full" />
                    </div>
                  </div>
                </div>
              </div>
