...
export default function CustomPackPage() {
  ...
  return <><Header /><main className="bg-[#FDFDF9] text-[#111111] pt-14 md:pt-28 pb-16"><div className="max-w-6xl mx-auto px-5">
    <div data-mobile-hero="inset" className="-mx-5 px-5 pt-8 pb-1 mb-8 md:contents"><p className="text-[#8D7020] uppercase tracking-widest text-xs mb-4">Uma visita, os artigos que escolher</p><h1 className="font-playfair text-4xl md:text-5xl mb-5">{preset ? `${preset.pack.name} em ${preset.city.name}` : 'Monte o seu pack de limpeza'}</h1>
    <p className="max-w-3xl text-lg text-[#555] mb-9">Adicione os seus sofás, colchões, cadeiras, tapetes ou alcatifas. Pode alterar esta combinação e escolher os tratamentos de cada artigo.</p></div>
    <div className="grid lg:grid-cols-[1fr_360px] gap-7 items-start"><section aria-label="Configurar artigos" className="space-y-5">
      ...
      <p className="text-xs text-white/65 mt-5">Preços de tabela por artigo. Uma deslocação. Valores sob orçamento confirmados separadamente.</p>
