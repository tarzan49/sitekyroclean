          ...
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4 md:gap-6 mb-6">
              ...
              <div className="relative aspect-[4/3] overflow-hidden rounded-sm">
                ...
                >
                  <AlertTriangle className="w-3 h-3 flex-shrink-0" style={{ color: "#D4AF37" }} /> O Problema {prep} {city.name}
                </span>
                <div className="absolute bottom-0 left-0 right-0 p-5 md:p-7 min-h-[130px] md:min-h-[150px] flex flex-col justify-start">
                  ...
                  <p className="text-sm text-white/85 leading-relaxed">{problem.problemDetail}</p>
                </div>
              </div>
              {/* Solução */}
              <div className="relative aspect-[4/3] overflow-hidden rounded-sm">
