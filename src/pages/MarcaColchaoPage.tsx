...
import { XCircle, ArrowRight, Search, Droplets, Wind, ShieldCheck, MessageCircle } from "lucide-react";
      ...
      <main>
        ...
        <section className="relative pt-24 md:pt-28 pb-14 md:pb-20 overflow-hidden bg-checker-dark">
          <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
            <img src={MARCA_HERO[marca.slug] ?? heroColchao} alt={pageTitle} className="w-full h-full object-cover" loading="eager" />
          </div>
          ...
          <div className="container mx-auto px-5 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-3xl">
              <nav className="flex items-center gap-1.5 text-xs text-white/50 mb-6" aria-label="Breadcrumb">
                ...
                <span>/</span>
                <Link to="/limpeza-colchoes" className="hover:text-white/80">Limpeza de Colchões</Link>
                <span>/</span>
                <span className="text-white/70">Colchão {marca.name}, {city.name}</span>
              </nav>
              ...
              <div className="flex gap-3 w-full sm:w-auto">
                <div className="relative group flex-1 sm:flex-none">
                  ...
                  <QuizButton className="w-full" buttonClassName="h-[52px] !py-0 w-full" initialLocation={city.name} initialService="mattress" />
                </div>
                <div className="relative group flex-1 sm:flex-none">
          ...
          <div className="container mx-auto px-5 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <h2 className="font-playfair text-2xl md:text-3xl font-bold text-[#111111] mb-8 text-center">
                Perguntas sobre Colchões {marca.name}
              </h2>
