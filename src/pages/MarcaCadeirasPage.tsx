...
const MarcaCadeirasPage = () => {
  ...
  const data = useMemo(() => {
    const route = getAllMarcaCadeirasRoutes().find(r => r.path === pathname);
    if (!route) return null;
    return getMarcaCadeirasByCityAndSlug(route.marcaSlug, route.citySlug);
  }, [pathname]);
  ...
  const snapshotStats = [
    ...
    { value: "1-2h", label: "Tempo de secagem", icon: Clock },
      ...
      <main>
              ...
              <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                <div>
                  <nav className="flex items-center gap-1.5 text-xs text-white/50 mb-6 flex-wrap" aria-label="Breadcrumb">
                    ...
                    <span>/</span>
                    <Link to="/limpeza-cadeiras" className="hover:text-white/80 transition-colors">Limpeza de Cadeiras</Link>
                    <span>/</span>
                ...
                <div className="hidden lg:block">
                  <div className="relative">
                    ...
                    <img
                      src={heroImg}
                      alt={`Limpeza de cadeiras ${marca.name} ${prep} ${city.name}`}
        ...
        <section className="py-14 md:py-20 bg-kyro-green">
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            <SectionHeader
              overline="Material"
              heading="O que saber sobre as cadeiras"
              goldWord={marca.name}
...
export default MarcaCadeirasPage;
