...
const materialDefinitions: MaterialDefinition[] = [
  ...
  // ── TAPETE MATERIALS ──
  {
    ...
    metaDescription: "Limpeza profissional de tapetes de lã. Preservamos a qualidade e cor das fibras naturais. Tratamento delicado. Orçamento gratuito.",
    ...
    faqs: [
      ...
      { question: "Quanto custa limpar um tapete de lã?", answer: "Cada tapete de lã é medido e orçamentado individualmente, conforme a dimensão e o estado da fibra. Tapetes orientais ou artesanais podem requerer tratamento especializado. Peça orçamento gratuito." },
    ],
  ...
  },
  {
    ...
    metaDescription: "Limpeza profissional de tapetes sintéticos. Remoção de manchas e odores. Resultados imediatos. Orçamento grátis.",
    ...
    faqs: [
      { question: "Quanto custa limpar um tapete sintético?", answer: "Cada tapete sintético é medido e orçamentado individualmente, conforme a dimensão e o estado da fibra. Tapetes sintéticos são geralmente mais económicos de limpar do que tapetes naturais." },
