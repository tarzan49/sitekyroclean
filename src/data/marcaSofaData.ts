...
export const marcas: MarcaSofa[] = [
  ...
  },
  {
    ...
    materialDescription: "Os sofás Roche Bobois são peças de design de alta gama com tecidos exclusivos importados — sedas, linho, veludo estruturado — ou couros selecionados. Cada modelo pode ter especificações únicas de manutenção.",
