...
const freguesiaLocalData: Record<string, FreguesiaLocalData> = {
  ...
  "fanzeres": { landmarks: ["Centro de Fânzeres", "zona leste de Gondomar"], localTip: "Área familiar: usamos produtos certificados e hipoalergénicos, adequados a casas com crianças e animais." },
...
const problemsByService: Record<string, ProblemSet[]> = {
  "limpeza-sofas": [
    ...
    { title: "Marcas de crianças e derrames no estofo", description: f => `Sumos, chocolate e marcas de brinquedos nos sofás são o dia-a-dia de famílias em ${f}. Usamos produtos certificados e hipoalergénicos, adequados a casas com crianças.` },
...
export function getDynamicContent(
  ...
  const selectedFaqs = getLandingFaqs({ serviceSlug: serviceSlug as LandingService, pageKey: `freguesia|${serviceSlug}|${municipio}|${freguesiaSlug}`, municipality: municipio, family: 'freguesia' });
