...
const LOCAL_EN_PAGES: EnPageData[] = [
  // ─── Algarve; guest/tourist pages (4) ────────────────────────────────
  {
    ...
    citySlug: "albufeira",
    region: "Algarve",
    title: "Emergency Stain Removal in Albufeira | Local Cleaning | Kyro Clean",
    metaDescription: "Wine, food or make-up stain on the sofa or mattress in your Albufeira holiday rental? Ask about same-day or next-day availability. English-speaking team, professional equipment.",
    h1: "Spilled something in your Albufeira",
    h1Gold: "holiday rental?",
    intro: "It happens to almost every guest at some point: a glass of wine on the sofa, sun cream on the mattress, sand and salt ground into a rug. We're a professional upholstery cleaning team based in the Algarve.",
    scenarios: [
      ...
      { title: "Mattress stains", body: "Whatever happened, we treat it discreetly and professionally, with a cleaning process suited to the fabric; antibacterial treatment is an optional extra as standard." },
    ],
    whyUs: [
      ...
      `${REVIEW_RATING}★ rating on Google from over ${REVIEW_COUNT} verified reviews`,
    ],
    faqs: [
  ...
  },
  {
    ...
    citySlug: "lagos",
    region: "Algarve",
    title: "Emergency Stain Removal in Lagos | Local Cleaning | Kyro Clean",
    metaDescription: "Accident on the sofa, rug or mattress in your Lagos holiday rental? Professional local cleaning, English-speaking team, no need to worry about the deposit.",
    h1: "Accident in your Lagos",
    h1Gold: "holiday rental?",
    intro: "A spilled drink, a sandy rug, a stained mattress: none of it needs to ruin your holiday or put your deposit at risk. We're a professional upholstery cleaning team covering Lagos and the western Algarve.",
    scenarios: [
      ...
      { title: "Mattress accidents", body: "Treated discreetly with a cleaning process suited to the fabric; antibacterial treatment is an optional extra, whatever the cause." },
    ...
    whyUs: [
      ...
      `${REVIEW_RATING}★ on Google, ${REVIEW_COUNT}+ verified reviews`,
    ],
    faqs: [
  ...
  },
  {
    ...
    citySlug: "portimao",
    region: "Algarve",
    title: "Emergency Stain Removal in Portimão | Local Cleaning | Kyro Clean",
    metaDescription: "Stain or spill on the sofa, mattress or rug in your Portimão holiday rental? Ask about same-day or next-day availability. English-speaking, professional, no fuss.",
    h1: "Something spilled in your Portimão",
    h1Gold: "rental?",
    intro: "It's more common than you'd think, and it's almost always fixable if it's treated properly. We're a professional upholstery and carpet cleaning team covering Portimão and the central Algarve.",
    scenarios: [
      ...
      { title: "Mattress or headboard stains", body: "Handled discreetly, with a cleaning process suited to the fabric; antibacterial treatment is an optional extra." },
  ...
  },
  {
    ...
    citySlug: "faro",
    region: "Algarve",
    title: "Emergency Stain Removal in Faro | Local Cleaning | Kyro Clean",
    metaDescription: "Stain or spill in your Faro holiday rental before a flight home? Professional local upholstery and mattress cleaning, English-speaking team.",
    h1: "Need it fixed before you",
    h1Gold: "fly home?",
    intro: "Faro is often the last stop before a flight home, which makes accidents feel worse than they are: a rushed spill, a mark left on the mattress. We're a professional upholstery cleaning team covering Faro and the surrounding area.",
    scenarios: [
  ...
  // ─── Algarve; host page (1) ───────────────────────────────────────────
  {
    ...
    metaDescription: "Fast upholstery and carpet cleaning for Airbnb and holiday-let hosts across the Algarve, with before/after photo documentation for damage claims. Same-day or next-day appointments, subject to availability.",
    ...
    whyUs: [
      ...
      `${REVIEW_RATING}★ on Google, ${REVIEW_COUNT}+ verified reviews, professional insured technicians`,
    ],
    faqs: [
      ...
      { question: "How fast can you respond to an urgent request?", answer: EN_RESPONSE_PROMISE + ". " + EN_AVAILABILITY_PROMISE },
    ],
  },
  ...
  // ─── Lisbon area; guest pages (8) ─────────────────────────────────────
  {
    ...
    citySlug: "lisboa",
    region: "Lisbon Area",
    title: "Emergency Stain Removal in Lisbon | Local Cleaning | Kyro Clean",
    metaDescription: "Wine, food or coffee stain on the sofa in your Lisbon holiday apartment? Professional local cleaning, English-speaking team, no need to worry about the deposit.",
    h1: "Spilled something in your Lisbon",
    h1Gold: "apartment?",
    intro: "A glass of Port wine, a coffee spill, a mark on the mattress: it happens, and it's almost always fixable if treated properly and promptly. We're a professional upholstery cleaning team covering Lisbon.",
    scenarios: [
      ...
      { title: "Mattress and headboard stains", body: "Handled discreetly, with a cleaning process suited to the fabric; antibacterial treatment is an optional extra, whatever the cause." },
    ...
    whyUs: [
      ...
      `${REVIEW_RATING}★ rating on Google, ${REVIEW_COUNT}+ verified reviews`,
    ],
    faqs: [
      { question: "Can you come today?", answer: EN_RESPONSE_PROMISE + ". " + EN_AVAILABILITY_PROMISE },
      { question: "Will it be dry before I check out?", answer: "Most sofas and rugs are usable again within 3 to 6 hours depending on ventilation, fabric and room conditions." },
  ...
  },
  {
    ...
    citySlug: "cascais",
    region: "Lisbon Area",
    title: "Emergency Stain Removal in Cascais | Local Cleaning | Kyro Clean",
    metaDescription: "Accident on the sofa, rug or mattress in your Cascais holiday rental? Professional local cleaning, English-speaking team.",
    h1: "Accident in your Cascais",
    h1Gold: "rental?",
    intro: "A spilled drink, sun cream on the sofa, sand ground into a rug: none of it needs to be stressful. We're a professional upholstery cleaning team covering Cascais and the Lisbon coast.",
    scenarios: [
      ...
      { title: "Mattress stains", body: "Treated discreetly with a cleaning process suited to the fabric; antibacterial treatment is an optional extra." },
    ],
    whyUs: [
...

  {
    ...
    citySlug: "sintra",
    region: "Lisbon Area",
    title: "Emergency Stain Removal in Sintra | Local Cleaning | Kyro Clean",
    metaDescription: "Stain or spill on the sofa, rug or mattress in your Sintra holiday rental? Professional local cleaning, English-speaking team.",
    h1: "Spilled something in your Sintra",
    h1Gold: "rental?",
    intro: "Sintra draws visitors year-round for its palaces and hills, and holiday rentals here see plenty of guests coming and going, which means accidents happen too. We're a professional upholstery cleaning team covering Sintra and the greater Lisbon area.",
    scenarios: [
      { title: "Wine or drink spills on the sofa", body: "Fresh spills respond very well to professional extraction, even a few hours later." },
      { title: "Mattress stains", body: "Treated discreetly with a cleaning process suited to the fabric; antibacterial treatment is an optional extra, whatever the cause." },
...

  {
    ...
    citySlug: "oeiras",
    region: "Lisbon Area",
    title: "Emergency Stain Removal in Oeiras | Local Cleaning | Kyro Clean",
    metaDescription: "Accident on the sofa, rug or mattress in your Oeiras holiday rental between Lisbon and Cascais? Professional local cleaning, English-speaking team.",
    h1: "Accident in your Oeiras",
    h1Gold: "rental?",
    intro: "Oeiras, on the coast between Lisbon and Cascais, is a popular short-term rental area year-round. We're a professional upholstery cleaning team covering Oeiras and the wider Lisbon coast.",
    scenarios: [
      { title: "Wine or drink spills on the sofa", body: "Fresh spills respond very well to professional extraction, even a few hours later." },
  ...
  },
  {
    ...
    citySlug: "almada",
    region: "Lisbon Area",
    title: "Emergency Stain Removal in Almada | Local Cleaning | Kyro Clean",
    metaDescription: "Stain or spill on the sofa, rug or mattress in your Almada holiday rental across the Tejo from Lisbon? Professional local cleaning, English-speaking team.",
    h1: "Spilled something in your Almada",
    h1Gold: "rental?",
    intro: "Almada, right across the Tejo from Lisbon and home to Cristo Rei, sees a steady flow of short-term rental guests all year. We're a professional upholstery cleaning team covering Almada and the south bank.",
    scenarios: [
  ...
  },
  {
    ...
    citySlug: "setubal",
    region: "Lisbon Area",
    title: "Emergency Stain Removal in Setúbal | Local Cleaning | Kyro Clean",
    metaDescription: "Accident on the sofa, rug or mattress in your Setúbal holiday rental? Professional local cleaning, English-speaking team.",
    h1: "Accident in your Setúbal",
    h1Gold: "rental?",
    intro: "Setúbal, gateway to the Arrábida coast, is a growing short-term rental destination near Lisbon. We're a professional upholstery cleaning team covering Setúbal and the surrounding area.",
    scenarios: [
      { title: "Wine or drink spills on the sofa", body: "Fresh spills respond very well to professional extraction, even a few hours later." },
  ...
  },
  {
    ...
    citySlug: "sesimbra",
    region: "Lisbon Area",
    title: "Emergency Stain Removal in Sesimbra | Local Cleaning | Kyro Clean",
    metaDescription: "Stain or spill on the sofa, rug or mattress in your Sesimbra holiday rental? Professional local cleaning, English-speaking team.",
    h1: "Spilled something in your Sesimbra",
    h1Gold: "rental?",
    intro: "Sesimbra's beaches and fishing-village charm make it a popular short-term rental spot south of Lisbon. We're a professional upholstery cleaning team covering Sesimbra and the surrounding area.",
    scenarios: [
  ...
  },
  {
    ...
    citySlug: "mafra",
    region: "Lisbon Area",
    title: "Emergency Stain Removal in Mafra | Local Cleaning | Kyro Clean",
    metaDescription: "Accident on the sofa, rug or mattress in your Mafra holiday rental near Sintra? Professional local cleaning, English-speaking team.",
    h1: "Accident in your Mafra",
    h1Gold: "rental?",
    intro: "Mafra, home to the famous National Palace and close to Ericeira's beaches, is a growing short-term rental base. We're a professional upholstery cleaning team covering Mafra and the surrounding area.",
    scenarios: [
      { title: "Wine or drink spills on the sofa", body: "Fresh spills respond very well to professional extraction, even a few hours later." },
  ...
  // ─── Lisbon area; host page (1) ───────────────────────────────────────
  {
    ...
    metaDescription: "Fast upholstery and carpet cleaning for Airbnb and holiday-let hosts in Lisbon, with before/after photo documentation for damage claims. Same-day or next-day appointments, subject to availability.",
    h1: "Guest damage before the next",
    h1Gold: "check-in?",
  ...
  // ─── Porto area; guest pages (8) ──────────────────────────────────────
  {
    ...
    citySlug: "porto",
    region: "Porto Area",
    title: "Emergency Stain Removal in Porto | Local Cleaning | Kyro Clean",
    metaDescription: "Wine, food or coffee stain on the sofa in your Porto holiday apartment? Professional local cleaning, English-speaking team, no need to worry about the deposit.",
    h1: "Spilled something in your Porto",
    h1Gold: "apartment?",
    intro: "A glass of Port wine, a coffee spill, a mark left on the mattress: it happens to most guests at some point, and it's almost always fixable if treated properly. We're a professional upholstery cleaning team based in Porto.",
    scenarios: [
  ...
  },
  {
    ...
    region: "Porto Area",
    title: "Emergency Stain Removal in Vila Nova de Gaia | Local Cleaning | Kyro Clean",
    metaDescription: "Accident on the sofa, rug or mattress in your Vila Nova de Gaia holiday rental, across the river from Porto? Professional local cleaning, English-speaking team.",
    h1: "Accident in your Gaia",
    h1Gold: "rental?",
    intro: "Vila Nova de Gaia, across the Douro from Porto's Ribeira, has become one of the busiest short-term rental areas in the region, and accidents in a rental are simply part of travel. We're a professional upholstery cleaning team covering Gaia and greater Porto.",
    scenarios: [
      { title: "Wine or drink spills on the sofa", body: "Fresh spills respond very well to professional extraction, even a few hours later." },
      { title: "Mattress stains", body: "Treated discreetly with a cleaning process suited to the fabric; antibacterial treatment is an optional extra, whatever the cause." },
      { title: "Rugs and carpeted areas", body: "Full extraction cleaning, not just a vacuum pass." },
  ...
  },
  {
    ...
    citySlug: "matosinhos",
    region: "Porto Area",
    title: "Emergency Stain Removal in Matosinhos | Local Cleaning | Kyro Clean",
    metaDescription: "Stain or spill on the sofa, rug or mattress in your Matosinhos holiday rental near Porto's beaches? Professional local cleaning, English-speaking team.",
    h1: "Spilled something in your Matosinhos",
    h1Gold: "rental?",
    intro: "Matosinhos, right on Porto's coastline, is a popular base for visitors who want beach and city in the same stay, which also means beach sand, salt and the odd spilled drink end up on the sofa or rug. We're a professional upholstery cleaning team covering Matosinhos and greater Porto.",
    scenarios: [
...

  {
    ...
    region: "Porto Area",
    title: "Emergency Stain Removal in Póvoa de Varzim | Local Cleaning | Kyro Clean",
    metaDescription: "Stain or spill on the sofa, rug or mattress in your Póvoa de Varzim holiday rental? Professional local cleaning, English-speaking team.",
    h1: "Spilled something in your Póvoa de Varzim",
    h1Gold: "rental?",
    intro: "Póvoa de Varzim, on the north coast near Porto, gets a steady stream of holiday-rental guests drawn by the beach and boardwalk. We're a professional upholstery cleaning team covering the north coast and greater Porto.",
    scenarios: [
  ...
  },
  {
    ...
    region: "Porto Area",
    title: "Emergency Stain Removal in Vila do Conde | Local Cleaning | Kyro Clean",
    metaDescription: "Accident on the sofa, rug or mattress in your Vila do Conde holiday rental? Professional local cleaning, English-speaking team.",
    h1: "Accident in your Vila do Conde",
    h1Gold: "rental?",
    intro: "Vila do Conde's historic centre and beaches make it a popular short-term rental spot on the north coast. We're a professional upholstery cleaning team covering the area and greater Porto.",
    scenarios: [
      { title: "Wine or drink spills on the sofa", body: "Fresh spills respond very well to professional extraction, even a few hours later." },
  ...
  },
  {
    ...
    citySlug: "espinho",
    region: "Porto Area",
    title: "Emergency Stain Removal in Espinho | Local Cleaning | Kyro Clean",
    metaDescription: "Stain or spill on the sofa, rug or mattress in your Espinho holiday rental south of Porto? Professional local cleaning, English-speaking team.",
    h1: "Spilled something in your Espinho",
    h1Gold: "rental?",
    intro: "Espinho's beach and casino draw a steady flow of short-term rental guests just south of Porto. We're a professional upholstery cleaning team covering Espinho and greater Porto.",
    scenarios: [
      { title: "Sand, salt and beach-day grime", body: "Common after a day at the beach, cleaned without over-wetting the fibres." },
      { title: "Wine or drink spills", body: "The sooner they're treated, the better the result." },
      { title: "Mattress stains", body: "Treated discreetly, with a cleaning process suited to the fabric; antibacterial treatment is an optional extra." },
  ...
  },
  {
    ...
    citySlug: "braga",
    region: "Porto Area",
    title: "Emergency Stain Removal in Braga | Local Cleaning | Kyro Clean",
    metaDescription: "Accident on the sofa, rug or mattress in your Braga holiday rental? Professional local cleaning, English-speaking team.",
    h1: "Accident in your Braga",
    h1Gold: "rental?",
    intro: "Braga's historic centre is a busy short-term rental destination year-round, and accidents in a rental are simply part of travel. We're a professional upholstery cleaning team covering Braga and the surrounding area.",
    scenarios: [
      { title: "Wine or drink spills on the sofa", body: "Fresh spills respond very well to professional extraction, even a few hours later." },
      { title: "Mattress stains", body: "Treated discreetly with a cleaning process suited to the fabric; antibacterial treatment is an optional extra, whatever the cause." },
  ...
  },
  {
    ...
    citySlug: "guimaraes",
    region: "Porto Area",
    title: "Emergency Stain Removal in Guimarães | Local Cleaning | Kyro Clean",
    metaDescription: "Stain or spill on the sofa, rug or mattress in your Guimarães holiday rental? Professional local cleaning, English-speaking team.",
    h1: "Spilled something in your Guimarães",
    h1Gold: "rental?",
    intro: "Guimarães, a UNESCO World Heritage city, is a popular short-term rental base year-round. We're a professional upholstery cleaning team covering Guimarães and the surrounding area.",
    scenarios: [
      { title: "Wine or drink spills on the sofa", body: "Fresh spills respond very well to professional extraction, even a few hours later." },
      { title: "Mattress stains", body: "Treated discreetly with a cleaning process suited to the fabric; antibacterial treatment is an optional extra, whatever the cause." },
  ...
  // ─── Porto area; host page (1) ────────────────────────────────────────
  {
    ...
    metaDescription: "Fast upholstery and carpet cleaning for Airbnb and holiday-let hosts in Porto, with before/after photo documentation for damage claims. Same-day or next-day appointments, subject to availability.",
    h1: "Guest damage before the next",
    h1Gold: "check-in?",
...
export const EN_PAGES: EnPageData[] = LOCAL_EN_PAGES.map(page => ({ ...page, intro: page.intro + ' ' + EN_AVAILABILITY_PROMISE, whyUs: [...page.whyUs, EN_RESPONSE_PROMISE, EN_COVERAGE_PROMISE] }));
