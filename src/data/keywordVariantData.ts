...
function content_higienizacao_tapetes(loc: string, ctx: string): ContentBlock {
  return {
    ...
    faqs: [
      ...
      { question: `Qual o preço mínimo de higienização de tapete em ${loc}?`, answer: `A partir de 5€/m², com preço mínimo de 25€ por serviço. O preço final depende do tipo de fibra e estado do tapete. Orçamento gratuito ao domicílio em ${loc}.` },
    ],
    problems: [
...
function content_higienizacao_cadeiras(loc: string, ctx: string): ContentBlock {
  return {
    ...
    faqs: [
      ...
      { question: `Qual o desconto para higienizar um lote grande de cadeiras em ${loc}?`, answer: `Até 3 cadeiras: 17,50€/cad. · 4 a 9 cadeiras: 15€/cad. · 10 ou mais: 12,50€/cad. Para lotes acima de 30 cadeiras há preço personalizado. Orçamento gratuito em ${loc}.` },
...
function content_lavagem_tapetes(loc: string, ctx: string): ContentBlock {
  return {
    ...
    faqs: [
      ...
      { question: `Qual o preço mínimo para lavagem de tapete pequeno em ${loc}?`, answer: `Preço mínimo de 25€ por tapete, a partir de 5€/m² para médios e grandes. O preço final depende do tipo de fibra e estado. Orçamento gratuito com recolha em ${loc}.` },
    ],
    problems: [
...
function content_impermeabilizacao_cadeiras(loc: string, ctx: string): ContentBlock {
  return {
    ...
    faqs: [
      ...
      { question: `Qual o desconto para impermeabilizar um lote de cadeiras de restaurante?`, answer: `A partir de 15€/cad. para 1 a 5 cadeiras, 12€/cad. para 6 a 10, e menos de 10€/cad. para lotes maiores. Orçamento personalizado para o seu restaurante em ${loc}.` },
