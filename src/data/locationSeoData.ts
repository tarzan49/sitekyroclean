...
function generateCadeirasContent(city: string, cityDesc: string): Omit<LocationService, 'slug' | 'city' | 'citySlug' | 'service' | 'serviceSlug' | 'relatedServices' | 'priceFrom'> {
  ...
  return {
    ...
    metaDescription: `Limpeza profissional de cadeiras estofadas ${prep} ${city}. Ideal para escritórios, restaurantes e residências. Desde 10€ por cadeira.`,
    h1: `Limpeza de Cadeiras Estofadas ${prep} ${city}`,
    intro: `Precisa de limpar cadeiras estofadas ${prep} ${city}? A Kyro Clean Solutions realiza limpeza profissional de cadeiras de escritório, cadeiras de jantar e cadeiras estofadas ${prep} ${city} e ${cityDesc}. Serviço rápido e eficaz ao domicílio ou no seu estabelecimento. Desde 10€ por cadeira.`,
    problems: [
    ...
    benefits: [
      "Preços por unidade a partir de 10€, com desconto para lotes de cadeiras",
    ...
    faqs: [
      { question: `Quanto custa limpar cadeiras estofadas ${prep} ${city}?`, answer: `A limpeza de cadeiras estofadas ${prep} ${city} começa a partir de 10€ por cadeira. Oferecemos descontos progressivos para quantidades maiores: ideal para escritórios e restaurantes.` },
