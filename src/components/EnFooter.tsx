    ...
    <footer className="bg-kyro-green text-white pt-10 md:pt-12 pb-10">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-base text-white/70 leading-relaxed max-w-2xl mx-auto mt-4">{EN_COVERAGE_PROMISE}</p><p className="text-base text-white/70 mt-3">{EN_RESPONSE_PROMISE}. {EN_AVAILABILITY_PROMISE}</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8 max-w-3xl mx-auto text-center sm:text-left">
          ...
          <div>
            <h3 className="type-card-title   mb-2 text-white/80 uppercase tracking-wide">Email</h3>
            <a href={BUSINESS_EMAIL_HREF} className="flex items-center justify-center sm:justify-start gap-2 text-base text-white/80 hover:text-gold transition-colors break-all">
              <Mail className="w-3.5 h-3.5 flex-shrink-0" />
              {BUSINESS_EMAIL}
            </a>
          </div>
          <div>
            <h3 className="type-card-title   mb-2 text-white/80 uppercase tracking-wide">Registered address</h3>
            <a href={GOOGLE_MAPS_URL} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center sm:justify-start gap-2 text-base text-white/80 hover:text-gold transition-colors">
        ...
        <div className="pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-white/80">
