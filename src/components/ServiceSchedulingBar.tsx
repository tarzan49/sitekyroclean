      ...
      <div className="flex gap-3 max-w-md animate-fade-in" style={{ animationDelay: "0.2s" }}>
        ...
        <div className="relative flex-1 group">
          ...
          <button
            ...
            className="relative w-full h-[54px] font-bold text-[#2a1800] text-[15px] rounded-full shadow-lg hover:shadow-[0_8px_28px_rgba(201,168,76,0.45)] transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] overflow-hidden"
          ...
          >
            ...
            />
            <span className="relative tracking-wide">Ver preço grátis</span>
          </button>
        </div>
