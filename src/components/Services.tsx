...
import sofaImgM        from "@/assets/hero-sofa-v4.jpeg";
...
import mattressImg     from "@/assets/hero-colchao-v2.png";
import mattressImgM    from "@/assets/hero-colchao-v2.png";
import chairsImg       from "@/assets/service-chairs-new.webp";
import chairsImgM      from "@/assets/service-chairs-new-mobile.webp";
import rugsImg         from "@/assets/hero-alcatifa-hero.jpeg";
import rugsImgM        from "@/assets/hero-alcatifa-hero.jpeg";
...
const Services = () => {
  ...
  const services = [
    ...
    { title: "Limpeza de Colchões", price: "39€",   image: mattressImg,   imageM: mattressImgM,   icon: iconMattress,   link: "/limpeza-colchoes",   altText: "Limpeza de Colchões",          badge: "Durma em ambiente puro"         },
    ...
    { title: "Limpeza de Tapetes", price: "5€/m²",  image: carpetImg,     imageM: carpetImgM,     icon: iconCarpet,     link: "/limpeza-tapetes",    altText: "Limpeza de Tapetes",           badge: "Cuidado delicado fibra a fibra" },
