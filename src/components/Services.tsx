...
const Services = () => {
  ...
  const services = [
    ...
    { title: "Limpeza de Tapetes", price: "15€/m²", image: carpetImg,     imageM: carpetImgM,     icon: iconCarpet,     link: "/limpeza-tapetes",    altText: "Limpeza de Tapetes",           badge: "Cuidado delicado fibra a fibra" },
