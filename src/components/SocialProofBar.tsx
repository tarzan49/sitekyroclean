...
const SocialProofBar = () => (
  <div className="bg-[#FAFAF7] border-b border-[#1A1A2E]/6">
    <div className="max-w-7xl mx-auto px-6 md:px-10">
      <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-[#1A1A2E]/6">
        {items.map((item, i) => (
          <div key={i} className="py-5 md:py-6 text-center">
            ...
            <p className="text-[9px] font-medium text-[#1A1A2E]/35 tracking-[0.22em] uppercase">
              {item.label}
            </p>
          </div>
        ))}
