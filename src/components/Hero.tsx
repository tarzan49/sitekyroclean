    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-center px-7 sm:px-12 md:px-14 lg:px-20 py-16 md:py-0 md:w-[52%] bg-white">
          ...
          {/* Heading */}
          <h1
            className="font-playfair font-light text-[#1A1A2E] mb-6 md:mb-8 transition-all duration-700 delay-75"
            style={{
          ...
          {/* Body */}
          <p
            className="text-[#1A1A2E]/50 leading-relaxed mb-10 md:mb-12 max-w-md transition-all duration-700 delay-150"
            style={{
          ...
          >
            ...
            <button
              ...
              className="flex items-center justify-center sm:justify-start gap-2 text-[#1A1A2E]/50 text-[10px] font-semibold tracking-[0.20em] uppercase py-4 hover:text-[#1A1A2E] transition-colors whitespace-nowrap touch-manipulation"
            >
              Ver Resultados
          ...
          >
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[11px] font-semibold text-[#1A1A2E] ml-1">5.0 Google</span>
            </div>
            <span className="w-px h-3 bg-[#1A1A2E]/12" />
            <span className="text-[10px] text-[#1A1A2E]/40 tracking-wide">+1000 clientes satisfeitos</span>
            <span className="w-px h-3 bg-[#1A1A2E]/12" />
            <span className="text-[10px] text-[#1A1A2E]/40 tracking-wide">Deslocação incluída</span>
          </div>
        </div>
      ...
      {!isQuizOpen && (
        <div
          className={`fixed bottom-0 left-0 right-0 bg-white border-t border-[#1A1A2E]/8 p-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] z-50 md:hidden transition-transform duration-300 ${
