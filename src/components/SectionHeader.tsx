const SectionHeader = ({
  ...
  <div className={`mb-10 md:mb-14 ${className}`}>
    <div className="flex items-center gap-3 mb-4">
      ...
      <p className="text-sm font-bold tracking-[0.08em] uppercase" style={{ color: light ? "#D4AF37" : "#D4AF37" }}>
        {overline}
      </p>
    </div>
    <h2 className={`type-section-title font-playfair      ${light ? "text-[#111111]" : "text-white"}`}>
      {heading}{" "}
      <em className="not-italic" style={{ color: light ? "#D4AF37" : "#D4AF37" }}>{goldWord}</em>
    </h2>
    {subtitle && (
