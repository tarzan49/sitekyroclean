      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <h3 className="type-card-title font-playfair  text-[#111111]    mb-4 flex-1">
              {featured.title}
            </h3>

            <p className="text-[13.5px] text-[#505650] leading-relaxed line-clamp-3 mb-6">
              {featured.intro}
            </p>

            <div className="flex items-center justify-between mt-auto">
              <span className="flex items-center gap-1.5 text-sm text-[#505650]">
          ...
          <div className="flex flex-col gap-4">
            {rest.map((post, i) => (
              ...
              >
                ...
                <h3 className="type-card-title font-playfair  text-[#111111]    mb-3 flex-1">
                  {post.title}
                </h3>
