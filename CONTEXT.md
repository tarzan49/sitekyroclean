...
- `locationPrices` (fonte única `QuizTypes.ts` + cópia standalone `locationSeoData.ts` para o `prerender.ts`): todas as zonas sobem +5€ — 0/5/10/15/20/25€ → 5/10/15/20/25/30€. Nenhuma zona fica a 0€; "Porto"/"Lisboa"/"Faro"/"Loulé" (antigo "Zona 0 grátis") passam a 5€.
