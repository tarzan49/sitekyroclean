...
const DATES = {
  ...
  faq: getContentDate(['src/pages/FAQEstofos.tsx', 'src/data/resourceContent.ts']),
  glossario: getContentDate(['src/pages/GlossarioEstofos.tsx', 'src/data/glossaryTerms.ts']),
